...
INSERT INTO "new_Snippet" ("content", "createdAt", "deleted", "excerpt", "favorite", "folderId", "id", "name") SELECT "content", "createdAt", "deleted", "excerpt", "favorite", "folderId", "id", "name" FROM "Snippet";
DROP TABLE "Snippet";
